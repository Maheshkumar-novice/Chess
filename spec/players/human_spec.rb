...
describe Human do
  ...
  describe '#make_choice' do
    let(:cell_choice_creator) { human.instance_variable_get(:@cell_choice_creator) }

    context 'when the user enters the valid choice' do
      before do
        valid_choice = 'a1'
        allow(cell_choice_creator).to receive(:human_choice).and_return(valid_choice)
      end

      it 'sends message human_choice to cell_choice_creator once' do
        expect(cell_choice_creator).to receive(:human_choice).once
        human.make_choice
      end

      it 'returns the valid choice' do
        result = human.make_choice
    ...
    context 'when the user enters invalid choice once then the valid choice' do
      before do
        invalid_choice = 'a'
        valid_choice = 'a1'
        allow(cell_choice_creator).to receive(:human_choice).and_return(invalid_choice, valid_choice)
      end

      it 'sends message human_choice to cell_choice_creator twice' do
        expect(cell_choice_creator).to receive(:human_choice).twice
        human.make_choice
      end
    ...
    context 'when the user enters invalid choice twice then the valid choice' do
      before do
        ...
        invalid_choice2 = ''
        valid_choice = 'a1'
        allow(cell_choice_creator).to receive(:human_choice).and_return(invalid_choice1, invalid_choice2, valid_choice)
      end

      it 'sends message human_choice to cell_choice_creator three times' do
        expect(cell_choice_creator).to receive(:human_choice).exactly(3).times
        human.make_choice
      end
  ...
  describe '#create_name' do
    ...
    context 'when the user enters the valid name' do
      ...
      it 'creates a valid name' do
        human.create_name
        name = human.instance_variable_get(:@name)
    ...
    context 'when the user enters invalid name once and then the valid name' do
      ...
      it 'sends message human_name to name_creator twice' do
    ...
    context 'when the user enters invalid name twice and then the valid name' do
      ...
      it 'sends message human_name to name_creator three times' do
